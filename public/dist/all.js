...
angular.module('group-project').controller('flashCardCtrl', function ($scope, flashCardSvc, $state, $stateParams) {
    ...
    $scope.saveSession = function () {
        if (confirm('Click OK to save progress.') === true) {
    ...
    $scope.recReactData = function () {
        flashCardSvc.getReact().then(function (response) {
            counter.count = 0;
            $scope.startData = response.data.firstCard;
            arrayLength = response.data.length;
            $scope.showCard = true;
    ...
    $scope.restartSession = function (value) {
        ...
        flashCardSvc.restartSession(value).then(function (response) {
            ...
            $state.go('flashCardsResume', { id: responseId });
        });
    };
});
'use strict';
...
angular.module('group-project').service('flashCardSvc', function ($http) {
    ...
    this.getJavascriptAll = function () {
        return $http({ url: '/api/getJSAll', method: 'GET' }).then(function (res) {
            return res;
        });
    };

    this.getJavascriptBasic = function () {
        return $http({ url: '/api/getJSBasic', method: 'GET' }).then(function (res) {
            return res;
        });
    };

    this.getJavascriptAdvanced = function () {
        return $http({ url: '/api/getJSAdvanced', method: 'GET' }).then(function (res) {
            return res;
        });
    };

    this.getReact = function () {
        return $http({ url: '/api/getReact', method: 'GET' }).then(function (res) {
            return res;
        });
    };

    this.getCss = function () {
        return $http({ url: '/api/getCss', method: 'GET' }).then(function (res) {
            return res;
        });
    };

    this.getHtml = function () {
        return $http({ url: '/api/getHtml', method: 'GET' }).then(function (res) {
            return res;
        });
    };
    ...
    this.getProfile = function () {
        return $http({ url: '/api/getUserData', method: 'GET' }).then(function (res) {
            return res;
        });
    };
    ...
    this.getRestart = function () {
        return $http({ url: '/api/getRestart', method: 'GET' }).then(function (res) {
            return res;
        });
    };
});
